  ...
  <Layout>
    ...
    <div className="flex flex-col">
      <div className="container mx-auto">
        <h1 className="text-center text-5xl md:text-5xl lg:text-6xl px-5 mt-16">Clever das Klima schützen!</h1>
    ...
    <div className="flex flex-col bg-blue pb-16 ">
      ...
      <div className="container mx-auto">
        <h1 className="text-center text-3xl md:text-4xl lg:text-5xl px-5 lg:pt-16">Vier neue <span className="px-2 bg-green">Challenges</span> jede Woche</h1>
        ...
        <h1 className="text-center text-3xl md:text-4xl lg:text-5xl px-5 lg:pt-16">Tipps im <span className="px-2 bg-green">Newsfeed</span> teilen</h1>
        ...
        <h1 className="text-center text-3xl md:text-4xl lg:text-5xl px-5 lg:pt-16">Spiel im <span className="px-2 bg-green">Team</span> oder für Dich</h1>
