    ...
    <footer className="min-h-screen-3/4 bg-green-light z-10 pt-6 pb-12 footer">
      <div className="flex flex-wrap">
        ...
        <div className="text-center sm:text-center md:text-left sm:w-full md:w-1/2 p-2">
          ...
          <div className="py-3">
            <AniLink className="block sm:text-sm md:text-base font-light no-underline hover:underline pb-1" fade to="/">Home</AniLink>
            <AniLink className="block sm:text-sm md:text-base font-light no-underline hover:underline py-1" fade to="/datenschutz">Datenschutz</AniLink>
            <AniLink className="block sm:text-sm md:text-base font-light no-underline hover:underline py-1" fade to="/about">Über uns</AniLink>
            <AniLink className="block sm:text-sm md:text-base font-light no-underline hover:underline py-1" fade to="/faq">FAQ </AniLink>
            <AniLink className="block sm:text-sm md:text-base font-light no-underline hover:underline py-1" fade to="/imprint">Impressum</AniLink>
            <AniLink className="block sm:text-sm md:text-base font-light no-underline hover:underline py-1" fade to="/wiki-link">Mach mit!</AniLink>
          </div>
